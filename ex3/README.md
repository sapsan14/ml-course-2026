...
Käsitle puuduvaid või ebaõigeid andmeid.
Vajadusel nimeta veerud selguse huvides ümber.
2. Andmete uurimine:

Kasuta Pandas-e funktsioone, et uurida andmestiku põhistatistikat, struktuuri ja sisu.
Tee kindlaks andmetega seotud võimalikud probleemid.
3. Andmete manipuleerimine:

Teisenda kategoorilised andmed analüüsimiseks sobivasse vormingusse.
4. Andmete visualiseerimine:

Visualisatsioonide loomiseks kasuta Matplotlibi ja Seaborni.
Visualisatsioonide tegemiseks järgi Notebook mallis antud soovitusi
5. Esita:

    - Jagatud jupyter notebook-ina.
